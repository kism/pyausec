...
class ElectionGrabber:
    ...
    def __init__(self, cache_dir: Path | None = None, current_election: str | None = None) -> None:
        ...
        self.election_root = self.get_election_id(current_election)
    ...
    def _get_latest_ftp_file_from_path(self, path: str, file_role: str, file_extension: str) -> Path:
        ...
        self._download_file(file_dir=path, file_name=preload_file, file_role=file_role)
        return self.tracked_files[file_role]

    def _download_file(self, file_dir: str, file_name: str, file_role: str) -> None:
    ...
    def refresh_ftp_file_list(self) -> None:
        ...
        """
        msg = f"Getting list of files from ftp://{FTP_URL}"
        logger.info(msg)
    ...
    def get_election_id(self, override: str | None) -> str:
    ...
    def get_election_info(self) -> str:
        """Populate election."""
        preload_path = self._get_preload()

        return self._get_file_as_str_from_zip(preload_path, f"xml/eml-110-event-{self.election_root}.xml")
    ...
    def get_candidate_info(self) -> str:
        ...
        return self._get_file_as_str_from_zip(preload_path, f"xml/eml-230-candidates-{self.election_root}.xml")
    ...
    def get_results(self) -> str:
        ...
        return self._get_file_as_str_from_zip(
            results_zip_path,
